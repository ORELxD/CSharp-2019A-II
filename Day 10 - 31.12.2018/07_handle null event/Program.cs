...
namespace _06_Student_action
{
    ...
    class Student
    {
        ...
        public void WakeUp(string str)
        {
            ...
            //we can not use: MorningActions?.Invoke(str);
...
students says: I called the class - second time
students says: I called the class - second time
*/
